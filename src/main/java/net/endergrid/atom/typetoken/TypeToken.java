...
public interface TypeToken<T> extends Type, AnnotatedElement {
    ...
    /**
     * Captures the `ITypeToken` from a `TypeTokenu.Capturing` instance, which provides
    ...
    /**
     * Represents a type variable constructed from {@link java.lang.reflect.TypeVariable}.
